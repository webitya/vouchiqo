...
import { adminFetchRevenueData, adminUpdatePayoutStatus } from "@/lib/api-helpers";
          ...
          <Card className="lg:col-span-4 bg-brand-bg border border-brand-border rounded-xl shadow-sm">
            ...
            <CardContent className="pt-4 space-y-4">
              ...
              <div className="flex justify-between items-center text-xs font-semibold">
                ...
                <span className="text-brand-navy font-bold">{planCounts?.starter || 0} merchants</span>
              </div>
              ...
              <div className="flex justify-between items-center text-xs font-semibold">
                ...
                <span className="text-brand-navy font-bold">{planCounts?.growth || 0} merchants</span>
              </div>
              ...
              <div className="flex justify-between items-center text-xs font-semibold">
                ...
                <span className="text-brand-navy font-bold">{planCounts?.pro || 0} merchants</span>
              </div>
              ...
              <div className="pt-3 border-t border-brand-border text-[10px] text-brand-subtext font-semibold flex items-center gap-1.5">
                ...
                <span>MRR aggregates active, approved merchant billing profiles.</span>
              </div>
            </CardContent>
          </Card>
                  ...
                  <TableBody className="divide-y divide-brand-border font-semibold text-brand-text">
                    {payouts.map((payout) => (
                      ...
                      >
                        ...
                        <TableCell className="p-4 text-brand-subtext font-bold max-w-[150px] truncate" title={payout.bankDetails}>
                          {payout.bankDetails}
                        </TableCell>
                        ...
                        <TableCell className="p-4 text-right">
                          {payout.status === "pending" ? (
                            ...
                            <span className="text-brand-subtext text-[10px] italic">Completed</span>
                          )}
                        </TableCell>
                      </TableRow>
                    ))}
        ...
        <Card className="bg-brand-bg border border-brand-border rounded-xl shadow-sm">
          ...
          <CardContent className="p-0 overflow-x-auto">
            {invoices && invoices.length > 0 ? (
                ...
                <TableBody className="divide-y divide-brand-border font-semibold text-brand-text">
                  {invoices.map((inv) => (
                    ...
                    >
                      ...
                      <TableCell className="p-4">{inv.businessName}</TableCell>
              ...
              <div className="p-6 text-center text-brand-subtext font-semibold">
                No active billing history. Only paid plan subscribers appear here.
              </div>
            )}
          </CardContent>
        </Card>
