    ...
    >
      ...
      <div className="flex-1 min-w-0 space-y-1.5 text-left">
        <div className="flex justify-between items-center gap-1.5">
          <h4 className="font-extrabold text-[10px] text-brand-navy uppercase tracking-wider truncate">{brandName}</h4>
        ...
        <div className="space-y-0.5">
          ...
          <p className="text-[11px] text-brand-subtext font-semibold leading-relaxed line-clamp-1">{coupon.title}</p>
        </div>
